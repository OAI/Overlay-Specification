# OpenAPI Overlay 1.2.x JSON Schema

Here you can find the JSON Schema for validating Overlays of versions 1.2.x.
...
For example, the value of `$id: https://spec.openapis.org/overlay/1.2/schema/2024-10-17` means this iteration was created on October 17, 2024.
...
The [test suite](../../tests/v1.2-dev) is part of this package.
