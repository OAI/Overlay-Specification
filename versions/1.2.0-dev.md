...
| <a name="reusable-action-reference-action-fields"></a>Any other field defined in the [Action Object](#action-object) | mixed | Any other field defined in the [Action Object](#action-object) to be used as an override to the value in the reusable action. |

This object MAY be extended with [Specification Extensions](#specification-extensions).

Fields of the Reusable Action Reference Object are combined with the `fields` of the referenced [Reusable Action Object](#reusable-action-object) to produce an effective [Action Object](#action-object).
Fields of the Reusable Action Reference Object override fields of the same name in the `fields` of the Reusable Action Object. The final result MUST be a valid Action Object.
