...
| Field Name | Type | Description |
| ---- | :----: | ---- |
| <a name="component-actions"></a>actions | Map(`string`, [Reusable Action Object](#reusable-action-object)) | A key-value set of reusable actions to reference in the actions through a [Reusable Action Reference Object](#reusable-action-reference-object). Optional. |
...
| <a name="reusable-action-parameter-default>default | `string` | A default string value for the parameter to use when no value is provided by the reference. Optional. |
