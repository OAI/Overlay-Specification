...
An Overlay document, whether represented in [[RFC8259|JSON]] or [[YAML|YAML]], MUST be applicable to an OpenAPI document represented in either [[RFC8259|JSON]] or [[YAML|YAML]]. Implementations MUST support application across differing formats.
